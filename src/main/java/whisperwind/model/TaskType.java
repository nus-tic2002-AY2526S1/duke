...
public enum TaskType {
    TODO("T", "model.Todo", "📝", "[T]", "Simple task without time"),
    DEADLINE("D", "model.Deadline", "⏰", "[D]", "model.Task with due date"),
    EVENT("E", "model.Event", "🎉", "[E]", "model.Event with start and end times"),
