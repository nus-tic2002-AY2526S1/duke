...
public class RecurrenceParser {
     ...
     *             If blank or "none" (case-insensitive), returns {@link Recurrence#none()}.
     ...
     */
    public static Recurrence parse(String args, ErrorType errorType) {
        ...
        try {
            ...
            return new Recurrence(type, freq);
